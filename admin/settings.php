...
if(isset($_POST['form3'])) {
    ...
    // updating the database
    $statement = $pdo->prepare("UPDATE tbl_settings SET newsletter_on_off=?, footer_about=?, footer_copyright=?, contact_address=?, contact_email=?, contact_phone=?, contact_map_iframe=?, footer_privacy=?, footer_return=?, footer_shipping=?, footer_terms=? WHERE id=1");
    $statement->execute(array($_POST['newsletter_on_off'],$_POST['footer_about'],$_POST['footer_copyright'],$_POST['contact_address'],$_POST['contact_email'],$_POST['contact_phone'],$_POST['contact_map_iframe'],$_POST['footer_privacy'],$_POST['footer_return'],$_POST['footer_shipping'],$_POST['footer_terms']));
...
if(isset($_POST['form7_11'])) {
    ...
    if($valid == 1) {
        ...
        $result = $statement->fetchAll(PDO::FETCH_ASSOC);                           
        foreach ($result as $row) {
            $policy_banner = $row['policy_banner'];
            unlink('../assets/uploads/'.$policy_banner);
        }

        // updating the data
        $final_name = 'policy_banner'.'.'.$ext;

        
        move_uploaded_file( $path_tmp, '../assets/uploads/'.$final_name );

        // updating the database
        $statement = $pdo->prepare("UPDATE tbl_settings SET policy_banner=? WHERE id=1");
        $statement->execute(array($final_name));

        $success_message = 'Privacy Policy Page Banner is updated successfully.';
                        ...
                        <form class="form-horizontal" action="" method="post">
                            <div class="box box-info">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">Footer - About </label>
                                        <div class="col-sm-9">
                                            <input class="form-control" type="text" name="footer_about"
                                                value="<?php echo $footer_about; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">Footer Privacy URL</label>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" name="footer_privacy"
                                                value="<?php echo $footer_privacy; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">Footer Return Policy URL </label>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" name="footer_return"
                                                value="<?php echo $footer_return; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">Footer Shipping Policy URL </label>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" name="footer_shipping"
                                                value="<?php echo $footer_shipping; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">Footer Terms and Conditions URL
                                        </label>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" name="footer_terms"
                                                value="<?php echo $footer_terms; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label"></label>
                        ...
                        <table class="table table-bordered">
                            <tr>
                                <form action="" method="post" enctype="multipart/form-data">
                                    <td style="width:50%">
                                        <h4>Existing Policy Page Banner</h4>
                                        <p>
                                            <img src="<?php echo '../assets/uploads/'.$policy_banner; ?>" alt=""
                                                style="width: 100%;height:auto;">
                                        </p>
                                    </td>
                                    <td style="width:50%">
                                        <h4>Change Policy Page Banner</h4>
                                        Select Photo<input type="file" name="photo">
                                        <input type="submit" class="btn btn-primary btn-xs" value="Change"
                                            style="margin-top:10px;" name="form7_11">
                                    </td>
                                </form>
                            </tr>
                            <tr>
