    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="index.php" class="logo">
                <span class="logo-lg">Radha Rani Textiles</span>
            </a>
                ...
                <ul class="sidebar-menu">
                    ...
                    <li
                        ...
                        <ul class="treeview-menu">
                            <li><a href="sale_banner.php"><i class="fa fa-circle-o"></i> Sale Banner</a></li>
                            ...
                            <li><a href="currency_manage.php"><i class="fa fa-circle-o"></i> Currency</a></li>
                    ...
                    <li
                        class="treeview <?php if( ($cur_page == 'product.php') || ($cur_page == 'product-add.php') || ($cur_page == 'product-edit.php') ) {echo 'active';} ?>">
                        <a href="product.php">
                    ...
                    <li
                        class="treeview <?php if( ($cur_page == 'customer.php') || ($cur_page == 'customer-add.php') || ($cur_page == 'customer-edit.php') ) {echo 'active';} ?>">
                        <a href="customer.php">
